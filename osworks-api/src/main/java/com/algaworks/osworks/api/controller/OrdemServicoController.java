...
public class OrdemServicoController {
	...
	public OrdemServicoDto criar(@Valid @RequestBody OrdemServicoInput ordemServicoInput) {
		...
		return toModel(gestaoOrdemServico.criar(os));
	}
	...
	public ResponseEntity<OrdemServicoDto> buscar(@PathVariable Long ordemServicoId) {
		...
		if(ordemServico.isPresent()) {
			OrdemServicoDto osdto = toModel(ordemServico.get());
	...
	private List<OrdemServicoDto> toListModel(List<OrdemServico> ordensServico) {
